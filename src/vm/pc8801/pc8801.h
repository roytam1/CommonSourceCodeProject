...
#define OPTION_SWITCH_HMB20	0x02
#define OPTION_SWITCH_GSX8800	0x04
#define OPTION_SWITCH_PCG8100	0x08
#define DIPSWITCH_CMDSING	0x10
#define DIPSWITCH_PALETTE	0x20
#define OPTION_SWITCH_FDD_5INCH	0x40
#define OPTION_SWITCH_FDD_8INCH	0x80
#define OPTION_SWITCH_M88_DISKDRV 0x100
#define DIPSWITCH_QUASIS88_CMT	0x200
#define OPTION_SWITCH_16BIT	0x400
#define OPTION_SWITCH_CDROM	0x800
#define DIPSWITCH_DEFAULT	DIPSWITCH_CMDSING
#define OPTION_SWITCH_DEFAULT	(OPTION_SWITCH_HMB20 | OPTION_SWITCH_GSX8800 | OPTION_SWITCH_PCG8100 | OPTION_SWITCH_FDD_5INCH | OPTION_SWITCH_CDROM)
